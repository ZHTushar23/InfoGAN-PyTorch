#!/bin/bash 
#SBATCH --job-name=es2_ada_dc        # Job name
...
#SBATCH --error=aada_files/es2infodc.err                # Error file name
#SBATCH --output=aada_files/es2infodc.out               # Output file name
# sza [60.0,40.0,20.0,4.0]
# vza [60,30,15,0,-15,-30,-60]
export CUDA_LAUNCH_BLOCKING=1
python ES2_train_ada_dc.py