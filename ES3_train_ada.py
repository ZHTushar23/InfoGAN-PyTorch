...
from ES3_config import params
from ES1_dataset import *
...
saved_model_root_dir = "ES3_saved_model"
try:
...
data_split_sub_dir = "data_split/cot_sza_%02d_vza_%02d"%(params['sza1'],params['vza1'])
...
for fold in range(2):
    saved_model_dir = saved_model_root_dir+"/fold_%01d_sza_%02d_vza_%02d"%(fold,params['sza1'],params['vza1'])
    try:
