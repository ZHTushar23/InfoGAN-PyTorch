...
from models.diffusion_mini_angle import DiffusionMiniCondD
"""
...
class Generator(nn.Module):
	def __init__(self,in_channels=12):
		...
		self.cam = DiffusionMiniCondD(in_channels=12,interim_channels=32,out_channels=1)
	def forward(self, x,c1,c2):
		img = F.relu(self.cam(x,c1,c2))
...
if __name__=="__main__":
	...
	context = torch.rand((1,72))
	netG = Generator()
	netQ = QHead()
	out_gen = netG(y,context,context)
