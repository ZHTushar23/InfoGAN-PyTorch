...
class NasaDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == "infoGAN" or self.mode=="infoGAN_cot":
...
if __name__=="__main__":
    ...
    for fold in range(1):    
        ...
        train_data = NasaDataset(root_dir=root_data_dir,filelist=data_split_dir+"data_split/cot_all/train.csv",mode="infoGAN_cot")
