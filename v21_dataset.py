...
from angle_embedding import get_embedder  
...
class NasaDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Repeat along each axis to match the shape of (72,72)
        sza_embed = sza_emb.repeat(72, 2)  # Repeat twice along both axes
        vza_embed = vza_emb.repeat(72, 2)
        ...
        dis_c = torch.zeros(2, 72, 72) # batch_size, sza+vza, dis_c_dim, dis_c_dim
