...
class NasaDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample = {'reflectance': reflectance, 'cot': cot_data,"sza":sza_temp,
                ...
                "sza_emb": sza_emb,"vza_emb": vza_emb,
...
if __name__=="__main__":
    ...
    print("SZA Emb:  ",sample['sza_emb'].shape,sample['vza_emb'].shape)
    ...
    print("SZA Emb:  ",sample_batch['sza_emb'].shape,sample_batch['vza_emb'].shape)