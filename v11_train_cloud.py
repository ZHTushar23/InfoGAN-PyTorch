...
from v11_config import params
from v11_dataset import NasaDataset
...
elif(params['dataset'] == 'Cloud11'):
    # Need to decide new models
    # Consider the input, output size of each blocks
    from models.cloud_model11 import Generator, Discriminator, DHead, QHead
...
for epoch in range(params['num_epochs']):
    ...
    for i, data_batch in enumerate(dataloader, 0):
        ...
        # print(q_mu.shape, q_var.shape)
        con_loss = 0
        if (params['num_con_c'] != 0):
            con_loss = criterionQ_con(noise[:, params['num_z']+ params['num_dis_c']*params['dis_c_dim'] :,0,0 ].view(-1, params['num_con_c']), q_mu, q_var)*0.1
