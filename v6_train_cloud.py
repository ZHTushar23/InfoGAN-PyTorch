...
from v6_config import params
from v6_dataset import NasaDataset
...
elif(params['dataset'] == 'Cloud6'):
    # Need to decide new models
    # Consider the input, output size of each blocks
    from models.cloud_model6 import Generator, Discriminator, DHead, QHead
