#!/bin/bash 
#SBATCH --job-name=ES1_test_full       # Job name
...
#SBATCH --error=aada_files/ES1testfp.err                # Error file name
#SBATCH --output=aada_files/ES1testfp.out               # Output file name
# sza [60.0,40.0,20.0,4.0]
# vza [60,30,15,0,-15,-30,-60]
export CUDA_LAUNCH_BLOCKING=1
python ES1_full_profile_test.py