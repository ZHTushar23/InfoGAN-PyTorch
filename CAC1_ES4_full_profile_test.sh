...
#SBATCH --error=aada_files/cac1ES4testfp.err                # Error file name
#SBATCH --output=aada_files/cac1ES4testfp.out               # Output file name
# sza [60.0,40.0,20.0,4.0]
# vza [60,30,15,0,-15,-30,-60]
export CUDA_LAUNCH_BLOCKING=1
python CAC1_ES4_full_profile_test.py