...
saved_model_root_dir = "es6_saved_model"
try:
...
valid_data = NasaDataset(root_dir=root_data_dir,
            filelist=data_split_dir+"data_split/cot_all_except_sza_4_vza_0/val.csv",
            mode="infoGAN_cot",transform=transform_func)
test_data = NasaDataset(root_dir=root_data_dir,
            filelist=data_split_dir+"data_split/cot_all_except_sza_4_vza_0/test.csv",
            mode="infoGAN_cot",transform=transform_func)
