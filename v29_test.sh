#!/bin/bash 
#SBATCH --job-name=v29_test       # Job name
...
#SBATCH --error=aada_files/v29test.err                # Error file name
#SBATCH --output=aada_files/v29test.out               # Output file name
# sza [60.0,40.0,20.0,4.0]
# vza [60,30,15,0,-15,-30,-60]
export CUDA_LAUNCH_BLOCKING=1
python v29_cloud_generate.py